   ...
   for(var i = 0; i < sensorGroupBy.length; i++){
       ...
       for(var j = 0; j<sensorGroupBy[i].sensorName.length; j++){
           ...
           if(j==5){
               ...
               tabletHtml += '<td><span style="margin: 2px;" class="badge waves-effect btnEditCombine" data-idcombine="'+sensorGroupBy[i].combineID+'" title="Edit"><u id="edit">Edit</u></span>'
                   + '<span <span style="margin: 2px;" class="badge waves-effect btnDeleteCombine" data-idcombine="'+sensorGroupBy[i].combineID+'" title="Delete"><u id="del">Delete</u></span></td>';
               countCol=0;
           }
       }
       if(countCol<5 && countCol != 0){
            for(var x=countCol; x < 6; x++){
                ...
                if(x==5){
                    ...
                    // + '<span <span style="margin: 2px;" class="badge badge-danger waves-effect btnDeleteCombine" data-idcombine="'+sensorGroupBy[i].combineID+'" title="Delete">Delete</span></td>';
                    tabletHtml += '<td><span <span style="margin: 2px;" class="badge waves-effect btnEditCombine" data-idcombine="'+sensorGroupBy[i].combineID+'" title="Edit"><u id="edit">Edit</u></span>'
                    + '<span <span style="margin: 2px;" class="badge waves-effect btnDeleteCombine" data-idcombine="'+sensorGroupBy[i].combineID+'" title="Delete"><u id="del">Delete</u></span></td>';
                    countCol=0;
                }
            }
